...
I also wanted to see what would happen if I took out the lowest performing frogs in each trial - the exp1a and exp2a datasets represent have 3 and 1 subjects removed from them, respectively.They ended up making the models worse, so I've decided to use the original data with all subjects included.
